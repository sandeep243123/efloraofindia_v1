...
export function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Typography
        ...
        className="flex items-center gap-x-2 p-1 font-medium"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="23px" height="22px" baseProfile="basic"><circle cx="16" cy="16" r="14" fill="#79b5ba" /><path fill="#302529" d="M16,31C7.729,31,1,24.271,1,16S7.729,1,16,1s15,6.729,15,15S24.271,31,16,31z M16,3	C8.832,3,3,8.832,3,16s5.832,13,13,13s13-5.832,13-13S23.168,3,16,3z" /><rect width="1" height="8" x="15.5" y="15" fill="#fff" /><rect width="1" height="3" x="15.5" y="9" fill="#fff" /></svg>
        <a href="#" className="flex items-center">
          About Us
        </a>
      </Typography>
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 mt-0">
      <div className="container mx-auto flex items-center justify-between text-pink-50">
        <Typography
          as="a"
          href="#"
        ...
        <div className="flex items-center gap-x-1">
          <Link to='/login'><Button variant="text" size="sm" className="hidden lg:inline-block">
            <span>Log In</span>
          </Button></Link>
